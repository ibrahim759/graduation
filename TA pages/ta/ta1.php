...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Create connection
    $conn = new mysqli('localhost', 'root', '', 'head');
    if ($conn->connect_error) {
        echo "$conn->connect_error";
        die("Connection Failed: " . $conn->connect_error);
    } else {
        $stmt = $conn->prepare("INSERT INTO table1 (offer1, offer2, offer3, offer4, offer5, offer6, offer7, offer8, _name) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("sssssssss", $offer1, $offer2, $offer3, $offer4, $offer5, $offer6, $offer7, $offer8, $_name);
